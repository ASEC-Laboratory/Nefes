...
For plots in notebook environment, always use plotly with the bundled Nefes theme.
In all forms of documentation, including docstrings and comments, do NOT use any specific jargon (e.g. software engineering, control engineering) except for commonly known concepts/terms and when it is absolutely necessary to do so.
