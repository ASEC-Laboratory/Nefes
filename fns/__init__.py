...
graph and solves for the steady mean flow and the linear acoustic behavior
around it, without resolving the full 3-D field.
...
doubles as the zero-frequency acoustic operator.
"""
